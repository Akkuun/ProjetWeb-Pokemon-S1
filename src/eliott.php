...
<main>
    ...
    <div id="main">
        <div id="content">
            ...
            <div class="article">
                <div class="text">
                    <h3>Qu’est-ce qu’une cryptomonnaie ?</h3>
                    <p>Mais qu’est-ce qu’une cryptomonnaie au-delà du Bitcoin ? La cryptomonnaie est une monnaie paire à
                        pair (P2P) sans aucun tiers de confiance, elles ne possèdent pas de support physique comme des
            ...
            <div class="article">
                <img src="res/img/developer.jpg" alt="Développeur"/>
                <div class="text">
            ...
            <div class="article">
                <div class="text">
                    <p>« just setting up my twttr » : Il s’agit du tout premier tweet posté sur la plateforme Twitter le
                        21
                        mars 2006. Il a été mis en vente aux enchères par Jack Dorsey, le créateur de Twitter lui-même
                        et la
            ...
            <div class="article">
                ...
                <div class="text">
                    ...
                    <p>Les NTF ou « Non-Fungitable Token » (en anglais, « jeton non échangeable ») font partie des
                        ...
                        possible de télécharger des images sur le Web, mais la possession d’un NFT certifie que l’image
                        ou
            ...
            <div class="article">
                <div class="text">
                    ...
                    <p>Les NFT ont été créés pour d’authentifier vos créations sur Internet même si les créateurs se
                        servent
                        de cette technologie pour vendre leur création et œuvre d’art afin de créer un réel marché de
                        l’art
                        en ligne.
                        <br><br>
                        C’est à cause de ce mouvement que certains artistes ce sont mettre leur œuvre en ventes sur ce
                        marché de l’art en ligne plutôt qu’ailleurs. Cela attire les collectionneurs qui sont prêts
                        payer
